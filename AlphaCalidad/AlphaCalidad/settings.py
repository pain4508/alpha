"""
Django settings for AlphaCalidad project.
...
ALLOWED_HOSTS = ['https://nuevaappdjango.azurewebsites.net']
...
ROOT_URLCONF = 'AlphaCalidad.urls'
...
WSGI_APPLICATION = 'AlphaCalidad.wsgi.application'
